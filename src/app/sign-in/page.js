...
const SignIn = () => {
  ...
  return (
    <div class="min-h-screen flex fle-col items-center justify-center py-6 px-4">
      <div class="  rounded-lg p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
          ...
          <div>
            ...
            <div class="relative flex items-center">
              <input
                ...
                type="email"
                required
                class="w-full text-sm text-black border border-gray-100 px-4 py-3 rounded-lg outline-blue-600"
